...
#########################################
## List Comprehension for Data Science ##
#########################################
...
tweet_clock_time = [entry[11:19] for entry in list(tweet_time)]
...
# Extract the clock time: tweet_clock_time
tweet_clock_time = [entry[11:19] for entry in list(tweet_time) if entry[17:19] == '19']
